...
<p align="center"><strong>基于 MiMo Code 的 macOS 原生桌面端应用。</strong></p>

---

## 项目简介

MiMo Code Dev 是对 [MiMo Code](https://github.com/XiaomiMiMo/MiMo-Code) 的 macOS 桌面端封装，采用 Electron 构建，提供原生桌面应用体验。
...
2. **原生界面优化** — 隐藏标题栏、毛玻璃效果、现代化 UI 设计
...
从 [Releases](https://github.com/cl6791731/MiMo-Code-Dev/releases) 页面下载最新版本：
...
```bash
# 克隆仓库
git clone https://github.com/cl6791731/MiMo-Code-Dev.git
cd MiMo-Code-Dev
